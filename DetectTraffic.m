function [fin t] = DetectTraffic(ImageBcg,ImageParam,video,path,name)
...
t = [];
fin = 0;
videoPath = fullfile(path, [name '_out.avi']);
rec = avifile(videoPath, 'fps', get(trafficObj, 'FrameRate'  )); %'Compression', 'i420'
...
for i=1:nframes
    ...
    idx = [L1.Area] > 2500; % vyprat pouze plochy s velkou plochou
